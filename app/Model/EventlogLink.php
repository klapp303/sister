    ...
    public function getEventlogDescription($year = null, $description = null)
    {
        ...
        //イベント履歴詳細ページの場合
            ...
            $array_description = array(
                2019 => '',
                2018 => '一見パワーバランスが変化したかもしれない年。<br>'
                      . '麻倉ももさんがソロデビューしたからね、嬉しかったよね。<br>'
                      . '実はユニットとソロを分けると、綺麗に4人を推せた年だったと思います。<br>'
                      . '推しに比例してイベント数も増えたので、レポが追いつかなくなってきてますね…ううむ。<br>'
                      . '…なんて言ってたら、最後にまた一人推しが増えました。どうしようこれ。',
                2017 => '推し事が充実した年。<br>'
