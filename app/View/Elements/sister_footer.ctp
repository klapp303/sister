...
<p class="foot-txt">
  <?php if (@$footer_title): ?>
  <span>copyright&#169 2015-2022</span> <?php echo $this->Html->link($footer_title, '/console/', array('target' => '_blank', 'class' => 'pc')); ?>
  <span class="mobile"><?php echo $footer_title; ?></span>
  <?php else: ?>
  <span>copyright&#169 2015-2022</span> <?php echo $this->Html->link('虹妹ｐｒｐｒ推進委員会', '/console/', array('target' => '_blank', 'class' => 'pc')); ?>
